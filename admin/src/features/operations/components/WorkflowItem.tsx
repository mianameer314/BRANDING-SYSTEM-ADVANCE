...
export function WorkflowItem({ item }: WorkflowItemProps) {
  ...
  return (
    <div className="group relative flex flex-col gap-3 rounded-lg border border-border bg-card p-4 shadow-sm hover:border-primary/50 hover:shadow-md transition-all">
