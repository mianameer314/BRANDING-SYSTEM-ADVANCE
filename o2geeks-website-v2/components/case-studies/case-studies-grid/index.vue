      ...
      <slide v-for="projects in getPosts" :key="projects.id">
        <div>
          ...
          <div class="d-flex ga-3">
            <template v-for="(tech, idx) in (Array.isArray(projects.technologies) ? projects.technologies : (projects.technologies ? projects.technologies.split(',') : [])).slice(0, 2)" :key="idx">
